import { WinnerFallbackJobPayload } from '@application/interfaces/queue/IWinnerFallbackQueue';
...
export class WinnerFallbackWorker {
    ...
    private async processJob(
        job: Job<WinnerFallbackJobPayload>,
    ): Promise<void> {
        const usecase = container.get<IProcessWinnerFallbackUsecase>(
            TYPES.IProcessWinnerFallbackUsecase,
        );
