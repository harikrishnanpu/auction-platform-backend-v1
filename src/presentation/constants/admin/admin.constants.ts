...
export const ADMIN_MESSAGES = {
    ...
    GET_DASHBOARD_STATS_SUCCESSFULLY: 'Dashboard stats fetched successfully',
    ...
    UPDATE_AUCTION_CATEGORY_SUCCESSFULLY:
        'Auction category updated successfully',
    ...
    CREATE_AUCTION_CATEGORY_SUCCESSFULLY:
        'Auction category created successfully',
